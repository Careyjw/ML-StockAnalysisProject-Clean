...
class RNNNormal:
        ...
        def calculate_total_loss(self, x, y):
            ...
            #print("Number training examples:", num_training_examples)
            
            #print(self.calculate_loss(x, y))
            
            return self.calculate_loss(x, y) / num_training_examples
        ...
        def calculate_loss (self, x, y):
            ...
            for i in np.arange(len(y)):
                ...
                #print("Correct Predictions:", correct_word_predictions)
                #print("O:", o)
        ...
        def backPropogation (self, x, y):
            ...
            time_steps = len(y)
            o,s,a = self.forward_prop(x);
            #print("Survived Forward Propagation")
            ...
            for t in np.arange(time_steps)[::-1]:
                ...
                for (back_prop_step) in np.arange(max(0, t-self.backPropTruncateAmount), t+1)[::-1]:
                    ...
                    #print("Survived a backtracing step...")
                #print("Survived a time step...")
        ...
        def train(self, x, y, verbose=False, batch_gradient_descent = False, batch_gradient_size = 100, eval_loss_after = 5, train_until_convergence = True, num_epochs = 20):
            ...
            bgd = True if batch_gradient_descent else False; # So this is the conditional statement in python's language. I only pray it translates into assembly
                #the nice way that C based language's conditional statements do.
                #This also takes care of the case when batch_gradient_descent is neither True nor False (aka 5, None, etc.)
        ...
        def __batch_step(self, x, y, batch_size):
            ...
            #print("Batch indices obtained...")
            
            for index in batch_indices:
                self.backPropogation(x[index], y[index])
        ...
        def __complete_training(self, step_method, x, y, verbose, eval_loss_after, step_args):
            ...
            while not ( len(self.losses) > 1 and (self.losses[-1] == self.losses[-2]) ):
                ...
                if (epochs % eval_loss_after == 0):
                    self.losses.extend([self.calculate_total_loss(x, y)])
